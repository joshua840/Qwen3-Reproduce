...
CUDA_VISIBLE_DEVICES=2 python src/run_video_qwen3vl.py --dataset MLVU --model_path Qwen/Qwen3-VL-4B-Instruct  --total_pixels 1750 --max_frames 16 
CUDA_VISIBLE_DEVICES=2 python src/run_video_qwen3vl.py --dataset MLVU --model_path Qwen/Qwen3-VL-4B-Instruct  --total_pixels 3500 --max_frames 32
CUDA_VISIBLE_DEVICES=2 python src/run_video_qwen3vl.py --dataset MLVU --model_path Qwen/Qwen3-VL-4B-Instruct  --total_pixels 7000 --max_frames 64
CUDA_VISIBLE_DEVICES=2 python src/run_video_qwen3vl.py --dataset MLVU --model_path Qwen/Qwen3-VL-4B-Instruct  --total_pixels 14000 --max_frames 128 &
